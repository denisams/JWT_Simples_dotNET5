...
namespace JWT.app
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AplicacaoContextoBD>(options => options.UseSqlServer(Configuration.GetConnectionString("ConnStr")));
            // For Identity  
            ...
            services.AddSwaggerGen(swagger =>
            {
                ...
                swagger.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme()
                {
                    ...
                    Description = "Entre com 'Bearer' e o token a seguir.\r\n\r\nExamplo: \"Bearer eyJhb111OiJIUzI1NiIsI123cCI6IkpXVCJ9\"",
                });
